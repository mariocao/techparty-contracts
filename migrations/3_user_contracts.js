...
const FootballContest = artifacts.require("FootballContest")

module.exports = function (deployer) {
  deployer.link(Witnet, [FootballContest])
  deployer.deploy(FootballContest, WitnetBridgeInterface.address)
}
